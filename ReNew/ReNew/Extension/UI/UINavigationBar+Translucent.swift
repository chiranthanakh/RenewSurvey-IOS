...
extension UIBarButtonItem {
    ...
    class func itemWithBackPic(colorfulImage: UIImage?, target: AnyObject, action: Selector,url : String = "") -> UIBarButtonItem {
        ...
        let currWidth = barButtonItem.customView?.widthAnchor.constraint(equalToConstant: 50.0)
        currWidth?.isActive = true
        let currHeight = barButtonItem.customView?.heightAnchor.constraint(equalToConstant: 50.0)
